...
class FormPage:
    def __init__(self, driver):
        ...
        self.submit_button = ("{By.XPATHlast_name}, address={address}, email={email}, phone={phone}, zip_code={zip_code}, city={city}, country={country}, job_position={job_position}, company={company}")
